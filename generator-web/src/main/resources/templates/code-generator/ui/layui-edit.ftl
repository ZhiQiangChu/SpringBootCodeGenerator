        ...
        <#list classInfo.fieldList as fieldItem >
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="${fieldItem.fieldName}" lay-verify="required"
                           lay-reqtext="${fieldItem.fieldComment}不能为空"
                           placeholder="请输入${fieldItem.fieldComment}"
                           value="￥{(${classInfo.className?uncap_first}.${fieldItem.fieldName})!!}"
                           class="layui-input">
